...
/*(function() {
    ...
    b.Sprite.prototype._renderCanvas = function(a, c) {
        if (!(!this.visible || 0 === this.alpha || !this.renderable || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            a.fd.on && a.fd.cb(this.blendMode)),
            this._mask && a.maskManager.pushMask(this._mask, a),
            this.texture.valid) {
            ...
            for (var e = 0; e < this.children.length; e++) {
                ...
                if (f.visible) {
                    ...
                    f.rotation % (2 * Math.PI) === 0)
                        ...
                        a.fd.on && a.fd.csb1(g, h.width, h.height, g.baseTexture.resolution);
                    else {
                        d || (d = !0),
                        ...
                        a.fd.on && a.fd.csb2(g, h.width, h.height, g.baseTexture.resolution)
                    }
                }
            }
            a.fd.on && a.fd.csbp()
    ...
    b.PixiShader.prototype.initUniforms = function() {
        ...
        for (var c in this.uniforms) {
            ...
            "2f" === d || "2i" === d ? a.glValueLength = 2 : "3f" === d || "3i" === d ? a.glValueLength = 3 : "4f" === d || "4i" === d ? a.glValueLength = 4 : a.glValueLength = 1)
        }
    }
    ,
    ...
    b.WebGLRenderer.prototype.render = function(a) {
        if (!this.contextLost) {
            ...
            this.game.fd.on && this.game.fd.record(),
    ...
    b.CanvasRenderer.prototype.render = function(a) {
        this.game.fd.on && this.game.fd.cr(),
        a.updateTransform(),
        this.context.setTransform(1, 0, 0, 1, 0, 0),
        ...
        this.context.clear()),
        this.clearBeforeRender && (this.transparent ? this.context.clearRect(0, 0, this.width, this.height) : (this.context.fillStyle = a._bgColor.rgba,
...
function() {
    ...
    c.Stage.prototype.setBackgroundColor = function(a) {
        this.game.transparent || (c.Color.valueToColor(a, this._bgColor),
        c.Color.updateColor(this._bgColor),
        this._bgColor.r /= 255,
        this._bgColor.g /= 255,
        this._bgColor.b /= 255,
        this._bgColor.a = 1)
    ...
    c.FrameDebugger.prototype = {
        ...
        stop: function() {
            ...
            this.count++,
            this.count === this.max && this.finish()
        },
        cr: function() {
            this.frame.push({
        ...
        finish: function() {
            ...
            for (var b = this.win.document.body, c = 0; c < this.log.length; c++) {
                var d = 0
                  ...
                  , g = 0
                  , h = 0;
                this.addTag(b, "h2", "Frame " + c),
                this.addTag(b, "p", "Frame Start @ " + e[0].time);
                for (var i = this.addTag(b, "ol", null , "strip"), j = i, k = [i], l = 1; l < e.length - 1; l++) {
                    ...
                    case this.CANVAS_DOC_STOP:
                        k.pop(),
                        j = k[k.length - 1],
                        this.addTag(j, "li", "DisplayObjectContainer Stop @ " + m.time);
                        break;
                    ...
                    case this.CANVAS_SPRITE_BATCH_RENDER_FAST:
                        this.addTag(j, "li", "Child (FastPath) (" + m.width + " x " + m.height + ")"),
                        d += this.addTexture(m, f),
                        g++;
                        break;
                    case this.CANVAS_SPRITE_BATCH_RENDER_SLOW:
                        this.addTag(j, "li", "Child (SlowPath) (" + m.width + " x " + m.height + ")"),
                        d += this.addTexture(m, f),
                        g++;
                        break;
                    case this.CANVAS_SPRITE_BATCH_STOP:
                        k.pop(),
                        j = k[k.length - 1],
                        this.addTag(j, "li", "SpriteBatch Stop @ " + m.time);
                        break;
                    case this.CANVAS_RENDER_SPRITE:
                        this.addTag(j, "li", "Sprite (" + m.width + " x " + m.height + ")"),
                        d += this.addTexture(m, f),
                        g++;
                        break;
                    case this.CANVAS_RENDER_TEXT:
                        this.addTag(j, "li", "Text (" + m.width + " x " + m.height + ")"),
                        d += this.addTexture(m, f),
                        g++;
                        break;
                    case this.CANVAS_RENDER_TILING_SPRITE:
                        this.addTag(j, "li", "Tiling Sprite (" + m.width + " x " + m.height + ")"),
                        d += this.addTexture(m, f),
                        g++;
                        break;
                    ...
                    case this.CANVAS_GRAPHICS_POLY:
                        this.addTag(j, "li", "Polygon (" + m.points + " points)"),
                        h++;
                        break;
                    case this.CANVAS_GRAPHICS_RECT:
                        this.addTag(j, "li", "Rectangle"),
                        h++;
                        break;
                    case this.CANVAS_GRAPHICS_CIRCLE:
                        this.addTag(j, "li", "Circle"),
                        h++;
                        break;
                    case this.CANVAS_GRAPHICS_ROUNDED_RECT:
                        this.addTag(j, "li", "Rounded Rectangle"),
                        h++;
                        break;
                    case this.CANVAS_GRAPHICS_ELIPSE:
                        this.addTag(j, "li", "Elipse"),
                        h++;
                        break;
                    case this.CANVAS_GRAPHICS_STOP:
                        k.pop(),
                        j = k[k.length - 1],
                        this.addTag(j, "li", "Render Graphics Stop @ " + m.time)
                    }
                }
                var m = e[e.length - 1]
                  , n = m.time - e[0].time;
                this.addTag(b, "p", "Frame Stop @ " + m.time),
                this.addTag(b, "p", "Frame Duration: " + n + "ms"),
                this.addTag(b, "p", "Total Objects Rendered: " + g + " (" + d + " pixels)"),
                this.addTag(b, "p", "Canvas Primitives Rendered: " + h),
                this.addTag(b, "p", "Unique Textures:");
                var o = this.addTag(b, "ol");
                for (var p in f)
                    this.addTag(o, "li", p + " - Times Used: " + f[p])
            }
        },
        addTexture: function(a, b) {
            var c = a.texture.baseTexture.source.src;
            return void 0 === c && (c = a.texture.baseTexture.source._pixiId),
    ...
    c.Game.prototype = {
        ...
        boot: function() {
            ...
            this.isBooted = !0,
            PIXI.game = this,
            this.fd = new c.FrameDebugger(this),
            this.math = c.Math,
            ...
            if (!window.PhaserGlobal || !window.PhaserGlobal.hideBanner) {
                ...
                this.device.chrome) {
                    for (var f = ["%c %c %c Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + b + " | " + d + "  %c %c %c http://phaser.io %c♥%c♥%c♥", "background: #9854d8", "background: #6c2ca7", "color: #ffffff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", "background: #ffffff"], g = 0; 3 > g; g++)
                        e > g ? f.push("color: #ff2424; background: #fff") : f.push("color: #959595; background: #fff");
    ...
    c.Pointer.prototype = {
        ...
        start: function(a) {
            ...
            b.y = this.y,
            b.position.setTo(this.x, this.y),
            b.onDown.dispatch(this, a),
            b.resetSpeed(this.x, this.y)),
            this._stateReset = !1,
            this.totalTouches++,
        ...
        update: function() {
            ...
            this.dirty = !1),
            this._holdSent === !1 && this.duration >= a.holdRate && ((a.multiInputOverride === c.Input.MOUSE_OVERRIDES_TOUCH || a.multiInputOverride === c.Input.MOUSE_TOUCH_COMBINE || a.multiInputOverride === c.Input.TOUCH_OVERRIDES_MOUSE && 0 === a.totalActivePointers) && a.onHold.dispatch(this),
            this._holdSent = !0),
        ...
        stop: function(a) {
            ...
            this.duration >= 0 && this.duration <= b.tapRate && (this.timeUp - this.previousTapTime < b.doubleTapRate ? b.onTap.dispatch(this, !0) : b.onTap.dispatch(this, !1),
    ...
    c.InputHandler.prototype = {
        ...
        validForInput: function(a, b, c) {
            return void 0 === c && (c = !0),
            !this.enabled || 0 === this.sprite.scale.x || 0 === this.sprite.scale.y || this.priorityID < this.game.input.minPriorityID ? !1 : (c || !this.pixelPerfectClick && !this.pixelPerfectOver) && (this.priorityID > a || this.priorityID === a && this.sprite.renderOrderID < b) ? !0 : !1
        },
    ...
    c.Component.Crop.prototype = {
        ...
        crop: function(a, b) {
            void 0 === b && (b = !1),
            a ? (b && null  !== this.cropRect ? this.cropRect.setTo(a.x, a.y, a.width, a.height) : b && null  === this.cropRect ? this.cropRect = new c.Rectangle(a.x,a.y,a.width,a.height) : this.cropRect = a,
    ...
    c.Component.LifeSpan.prototype = {
        ...
        revive: function(a) {
            ...
            this.exists = !0,
            this.visible = !0,
            "function" == typeof this.heal && this.heal(a),
    ...
    c.Button.prototype.onInputOverHandler = function(a, b) {
        b.justReleased() && (this.justReleasedPreventsOver & b.pointerMode) === b.pointerMode || (this.changeStateFrame(f),
    ...
    c.BitmapData.prototype = {
        ...
        setPixel32: function(a, b, d, e, f, g, h) {
            return void 0 === h && (h = !0),
            a >= 0 && a <= this.width && b >= 0 && b <= this.height && (c.Device.LITTLE_ENDIAN ? this.pixels[b * this.width + a] = g << 24 | f << 16 | e << 8 | d : this.pixels[b * this.width + a] = d << 24 | e << 16 | f << 8 | g,
    ...
    c.Text.prototype.updateText = function() {
        ...
        var n = f.fontSize + this.style.strokeThickness + this.padding.y
          , o = n * b.length
          , p = this._lineSpacing;
        if (0 > p && Math.abs(p) > n && (p = -n),
        0 !== p) {
            var m = p * (b.length - 1);
            o += m
        }
        this.canvas.height = o * this._res,
        ...
        g = 0; g < b.length; g++)
            q = this.style.strokeThickness / 2,
            r = this.style.strokeThickness / 2 + g * n + f.ascent,
            g > 0 && (r += p * g),
            "right" === this.style.align ? q += e - d[g] : "center" === this.style.align && (q += (e - d[g]) / 2),
            this.autoRound && (q = Math.round(q),
            r = Math.round(r)),
            this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? this.updateLine(b[g], q, r) : (this.style.stroke && this.style.strokeThickness && (this.updateShadow(this.style.shadowStroke),
            0 === c ? this.context.strokeText(b[g], q, r) : this.renderTabLine(b[g], q, r, !1)),
            this.style.fill && (this.updateShadow(this.style.shadowFill),
            0 === c ? this.context.fillText(b[g], q, r) : this.renderTabLine(b[g], q, r, !0)));
        this.updateTexture()
    }
    ,
    ...
    c.Text.prototype._renderCanvas = function(a) {
        this.dirty && (a.fd.on && a.fd.tu(),
        this.updateText(),
        this.dirty = !1),
        a.fd.on && a.fd.ct(this.texture, this.texture.width, this.texture.height, this.texture.baseTexture.resolution),
    ...
    c.Device._initialize = function() {
        function a() {
            ...
            /Playstation Vita/.test(a) ? l.vita = !0 : /Kindle/.test(a) || /\bKF[A-Z][A-Z]+/.test(a) || /Silk.*Mobile Safari/.test(a) ? l.kindle = !0 : /Android/.test(a) ? l.android = !0 : /CrOS/.test(a) ? l.chromeOS = !0 : /iP[ao]d|iPhone/i.test(a) ? (l.iOS = !0,
            navigator.appVersion.match(/OS (\d+)/),
            l.iOSVersion = parseInt(RegExp.$1, 10)) : /Linux/.test(a) ? l.linux = !0 : /Mac OS/.test(a) ? l.macOS = !0 : /Windows/.test(a) && (l.windows = !0),
            ...
            for (var a in this.parent.properties) {
                ...
                Array.isArray(this.vEnd[a])) {
                    if (0 === this.vEnd[a].length)
                        continue;0 === this.percent && (this.vEnd[a] = [this.vStart[a]].concat(this.vEnd[a]))
                }
    ...
    c.AnimationParser = {
        ...
        JSONDataPyxel: function(a, b) {
            ...
            if (d.forEach(function(a) {
                return b[a] ? void 0 : (console.warn("Phaser.AnimationParser.JSONDataPyxel: Invalid Pyxel Tilemap JSON given, missing '" + a + "' key."),
                void console.log(b))
            }),
            1 != b.layers.length)
    ...
    c.Loader.prototype = {
        ...
        fileComplete: function(a, b) {
            ...
            case "textureatlas":
                ...
                a.format == c.Loader.TEXTURE_ATLAS_JSON_ARRAY || a.format == c.Loader.TEXTURE_ATLAS_JSON_HASH || a.format == c.Loader.TEXTURE_ATLAS_JSON_PYXEL)
